...
import 'package:tif/screens/search/searched_event_detail_page.dart'; 
import '../../data/model/searched_event_model.dart';


class SearchedEventsListViewCard extends StatelessWidget {
  List<Data> list;
  int idx;
  SearchedEventsListViewCard({
    Key? key,
    required this.list,
    required this.idx,
  }) : super(key: key);
  ...
  //  print(formattedDateTime);
    return InkWell(
      onTap: (){
       ...
       SearchedEventDetailPage(data: list[idx]),));
      },
      child: Padding(
